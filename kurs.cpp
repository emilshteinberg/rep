...
<<<<<<< HEAD
	Дата создания программы: --/12/2020
	Версия: 1.0
=======
	Дата создания программы: 07/11/2020
	Версия: 5.3
>>>>>>> parent of 5423017 (Р’РѕСЃСЃС‚Р°РЅРѕРІР»РµРЅР° РѕРґРЅР° СЃС‚СЂРѕРєР°)
	Формулировка:
	Дано N точек на плоскости. Программа находит:
	Все пары квадратов с вершинами в этих точках, имеющих наибольшую площадь пересечения.
	
	Вывод вершин квадратов осуществляется по часовой стрелке.
	Рассматриваются стороны фигур, расположенные произвольным образом.
<<<<<<< HEAD
	
	Все значения берутся из файла input.txt
*/
=======
*/
...
int main()
{
	...
	"Дата создания программы: --/12/2020\nВерсия: 1.0\n\nФормулировка:\n" <<
	"Дано произвольное количество точек на плоскости. Программа находит\n" <<
	"все пары квадратов с вершинами в этих точках, имеющих наибольшую площадь\nпересечения." <<
	"Заданные условия:\n1. Вывод вершин квадратов осуществляется по часовой стрелке.\n" <<
	"2. Рассматриваются стороны фигур, расположенные произвольным образом." << endl;
